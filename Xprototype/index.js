...
const str1 = new String("i'm more than a string, i'm an object")// при создании же строки через очередной класс js " new String" строка становится оьъектом в явном виде, гпри этом строк увеличивается на число элементов строки.