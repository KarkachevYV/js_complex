...
console.log(adults)//традиционый подход отфильтровывания по возрасту
...
//при этом, если мы будем использовать весь функционал стрелочных функций данная запись будет ещё короче
...
console.log(newPeople)//здесь мы изменим елементы массива по своему усмотрению
